...
def endless_parsing():
    print(str(datetime.now()) + ' - endless_parsing')
    while True:
        try:
            print(str(datetime.now()) + ' - endless_parsing_try')
            ...
            print(str(datetime.now()) + ' - endless_parsing error')
            print(error)
...
def get_bot_update(update):
    print(str(datetime.now()) + ' - get_bot_update')
    bot.process_new_updates([update])


def set_hook():
    print(str(datetime.now()) + ' - set_hook')
    bot.remove_webhook()
    time.sleep(2)
...
def main():
    print(str(datetime.now()) + ' - main')
    create_database()
    init_last_posts()
    print(str(datetime.now()) + ' - after_init_last_posts')
    client_process = Process(target=endless_parsing, args=())
    print(str(datetime.now()) + ' - after_client_process_1')
    client_process.start()
    print(str(datetime.now()) + ' - after_client_process_2')
